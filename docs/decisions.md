...
| D43 | JavaScript budget | Settled 2026-09-13 (plan 10): 10 KB of inline script in total and 7 KB on any one page, up from 5 KB in total. Every page still works with none of it, which is the rule the number stands for. |
